...
import ReactPlayer from "./ReactPlayer"; // your local component
...
const TrailersSection = () => {
  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 pt-10 py-20">
      ...
      <div className="relative mt-1">
        ...
        <div className="relative mx-auto w-full max-w-[960px] pt-[56.25%]">
